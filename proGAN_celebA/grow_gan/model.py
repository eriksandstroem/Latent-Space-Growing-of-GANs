...
def G(z, batch_size=64, reuse = False, bn = True, layers = 12, activation = 'lrelu', output_dim = 128,
    feature_map_shrink = 'n', spatial_map_growth = 'n', alpha = 1, useAlpha = 'y', beta = 1, useBeta = 'y', use_wscale = True, use_pixnorm = True):
...
def D(image, batch_size=64, reuse = False, bn = True, layers = 12, activation = 'lrelu', input_dim = 128,
    feature_map_growth = 'n', spatial_map_shrink = 'n', stage = 'i', alpha = 1, useAlpha = 'y', beta = 1, useBeta = 'y', z_dim = 8, minibatch_std = True, use_wscale = True):
