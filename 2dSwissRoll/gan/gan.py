...
parser.add_argument('--lr', '--learning-rate', default=5, type=float, help='learning rate (default: 0.001)')
parser.add_argument('--tn', '--train_noise', default=0.0, type=float, help='train noise std (default: 0.0)')
parser.add_argument('--i', '--iterations', default=5050, type=int, help='iterations (default: 15 050)')
