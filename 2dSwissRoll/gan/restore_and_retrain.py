...
if not os.path.exists('../models/g_'+arg.g+'grown/d_'+arg.d+'/noise_'+str(arg.n)+'_lr_'+str(arg.lr)+'_zdim_'+str(arg.zdim)+'_z_'+arg.z+'_loss_'+arg.l):
    os.makedirs('../models/g_'+arg.g+'grown/d_'+arg.d+'/noise_'+str(arg.n)+'_lr_'+str(arg.lr)+'_zdim_'+str(arg.zdim)+'_z_'+arg.z+'_loss_'+arg.l)
if not os.path.exists('../logs/g_'+arg.g+'grown/d_'+arg.d):
    os.makedirs('../logs/g_'+arg.g+'grown/d_'+arg.d)
if not os.path.exists('../plots/g_'+arg.g+'grown/d_'+arg.d+'/noise_'+str(arg.n)+'_lr_'+str(arg.lr)+'_zdim_'+str(arg.zdim)+'_z_'+arg.z+'_loss_'+arg.l):
    os.makedirs('../plots/g_'+arg.g+'grown/d_'+arg.d+'/noise_'+str(arg.n)+'_lr_'+str(arg.lr)+'_zdim_'+str(arg.zdim)+'_z_'+arg.z+'_loss_'+arg.l)
